...
DecisionRecommendation selects one complete evaluated StrategyOption by ID and carries a non-empty, uniquely identified evaluation set. Triggers may still activate one concrete StrategyAction. Race-time distribution summaries belong in ModelEstimate uncertainty such as empirical P10/P50/P90; raw simulator samples remain internal or diagnostic.
